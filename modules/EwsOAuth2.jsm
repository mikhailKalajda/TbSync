...
function openBrowserWindow(options) {
  ...
  return new Promise((resolve, reject) => {
    ...
    let browserWindow = Services.ww.openWindow(Services.ww.activeWindow, "chrome://tbsync/content/moreinfo.xhtml", "", "centerscreen,chrome,location,width=980,height=750", null);
    browserWindow.addEventListener("load", e => {
      ...
      let notification = notificationbox.appendNotification(label, "", "chrome://tbsync/skin/letter-x-icon-16.png", notificationbox.PRIORITY_INFO_LOW);
