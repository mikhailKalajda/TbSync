...
async function main() {
  if (await browser.manifestLoader.needsRestart("tbsync")) {
  ...
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/messenger.xul", "chrome://tbsync/content/mwoOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/messengercompose/messengercompose.xul", "chrome://tbsync/content/messengerComposeOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/msgAccountCentral.xul", "chrome://tbsync/content/msgAccountCentralOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/messageWindow.xul", "chrome://tbsync/content/msgHVOoverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/messenger.xul", "chrome://tbsync/content/msgHVOoverlay.xul");
  ...
  // Register overlays
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/AccountManager.xul", "chrome://tbsync/content/AccountManagerOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/addressbook/addressbook.xul", "chrome://tbsync/content/addressbookOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/am-identity-edit.xul", "chrome://tbsync/content/am-identityOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/am-main.xul", "chrome://tbsync/content/am-mainOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/folderProps.xul", "chrome://tbsync/content/folderPropsOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/messenger.xul", "chrome://tbsync/content/messengerOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/messageWindow.xul", "chrome://tbsync/content/mwoOverlay.xul");
  //
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/messenger.xul", "chrome://tbsync/content/mwoOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/messengercompose/messengercompose.xul", "chrome://tbsync/content/messengerComposeOverlay.xul");
  await browser.manifestLoader.registerOverlay("chrome://messenger/content/msgAccountCentral.xul", "chrome://tbsync/content/msgAccountCentralOverlay.xul");
