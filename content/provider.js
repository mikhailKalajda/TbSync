...
var Base = class {
    ...
    static async load() {
        ...
        try {
            ...
            if (TbSync.lightning.isAvailable()) {
                ...
                let aliasData = await eas.tools.fetchFile("chrome://tbsync/content/timezonedata/Aliases.csv");
                let aliasNames = {};
                ...
                let csvData = await eas.tools.fetchFile("chrome://tbsync/content/timezonedata/WindowsTimezone.csv");
    ...
    static getProviderIcon(size, accountData = null) {
        ...
        switch (size) {
            case 16:
                return "chrome://tbsync/content/skin/" + base + "16.png";
            case 32:
                return "chrome://tbsync/content/skin/" + base + "32.png";
            default :
                return "chrome://tbsync/content/skin/" + base + "64.png";
        }
    }
    ...
    static getCreateAccountWindowUrl() {
        return "chrome://tbsync/content/manager/createAccount.xul";
    }
    ...
    static getEditAccountOverlayUrl() {
        return "chrome://tbsync/content/manager/editAccountOverlay.xul";
    }
...
Services.scriptloader.loadSubScript("chrome://tbsync/content/includes/network.js", this, "UTF-8");
Services.scriptloader.loadSubScript("chrome://tbsync/content/includes/wbxmltools.js", this, "UTF-8");
Services.scriptloader.loadSubScript("chrome://tbsync/content/includes/xmltools.js", this, "UTF-8");
Services.scriptloader.loadSubScript("chrome://tbsync/content/includes/tools.js", this, "UTF-8");
Services.scriptloader.loadSubScript("chrome://tbsync/content/includes/sync.js", this, "UTF-8");
