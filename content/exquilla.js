...
(function _exquilla()
{
  ...
  if (typeof (pub.Utils) == "undefined")
    Object.assign(pub, ChromeUtils.import("resource://tbsync/ewsUtils.jsm"));

  Object.assign(pub, ChromeUtils.import("resource://tbsync/ewsAbService.jsm"));
  Object.assign(pub, ChromeUtils.import("resource://tbsync/PromiseUtils.jsm", pub));
  ...
  const exquillaStrings = Cc["@mozilla.org/intl/stringbundle;1"]
                                ...
                                .createBundle("chrome://tbsync/locale/exquilla.properties");
  ...
  function onLoad()
  {
    ...
    let ewsServer = null;
    log.warn('Ci.nsIMsgIncomingServer=' + Ci.nsIMsgIncomingServer);
    try {
    ...
    try  {
      let { ewwActivityModule } = ChromeUtils.import("resource://tbsync/ewsActivity.js");
